...
async function checkEvents() {
	...
	console.log( `Processing ${openEvents.length} due events...` );
	for ( let i = 0; i < openEvents.length; i++ ) {
		...
		switch ( event.type ) {
			case 'unlock_lesson':
				...
				console.log( `Unlock lesson ${lessonName} of course ${namespaceName} at ${timeString}...` );
			...
			case 'send_email':
				...
				console.log( `Sending email to ${mail.to} at ${timeString}...` );
