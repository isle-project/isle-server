...
/**
* Counts the number of mastered lessons
*
* @param {Object} lessonData - user lesson data
* @returns {number} number of mastered lessons
*/
...
/**
* Returns an object with the user's action types and their associated counts.
*
* @param {Object} lessonData - user lesson data
* @returns {Object} hash table of action types and associated counts
*/
...
/**
* Counts the number of chat messages of user over all lessons.
*
* @param {Object} lessonData - user lesson data
* @returns {number} number of chat messages associated with user
*/
...
/**
* Returns an array of newly awarded badges for the specified user.
*
* @param {Object} user - user object
* @returns {Array} badge array
*/
