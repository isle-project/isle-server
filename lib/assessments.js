...
* /assessment_refs:
*   post:
*    summary: Retrieve assessment refs
*    description: Retrieve assessment refs for a set of entities.
*    tags: [Assessments]
*    body:
*      application/json:
*        schema:
...
*             schema:
*               type: array
*               description: Array of unique assessment refs associated with the entities
*               items:
*                 type: string
*/
router.post( '/assessment_refs',
	passport.authenticate( 'jwt', { session: false }),
	wrapAsync( async function onAssessmentRefs( req, res ) {
...
router.post( '/update_metric',
	...
	wrapAsync( async function onUpdateMetric( req, res ) {
		...
		if ( ref !== void 0 ) {
			updateSpec[ 'assessments.$.ref' ] = ref;
		}
