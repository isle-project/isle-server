...
/**
* Checks whether a GET request for a static file originates from the dashboard or a lesson.
*
...
* @returns {void}
*/
function inLessonOrDashboard( req, res, next ) {
...
module.exports = inLessonOrDashboard;
