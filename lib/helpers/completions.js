 ...
 *
 * @param {Object|null} [policyOptions] - an object whose keys form a subset of allowed policies. If missing, the
 *       default policy is used; see descriptions below.
 ...
 *   @param {Object} [policyOptions.tagWeights=void 0] - if defined, a map of strings representing tags by which
 *       completion values are aggregated to non-negative weights. If empty, all extant tags are equally weighted. If no tags are defined in
