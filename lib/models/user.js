 ...
 *           lessonGrades:
 *             type: object
 *             object with keys being lesson IDs, each of which points to an object of key-value pairs, with the keys being IDs of questions in the respective lessons and the values corresponding to the awarded points for said questions.
...
UserSchema.pre( 'save', function save( next ) {
	...
	if ( user.isNew ) {
		mongoose.models.User.countDocuments({
			...
			// Generate a salt:
			bcrypt.genSalt( SALT_WORK_FACTOR, onSalt );
		});
	} else {
