...
const splitName = ( name ) => {
	if ( name === void 0 ) return [ void 0, void 0, void 0 ];
	const getNickname = name => capitalize(/^\((.*)\)$/.exec( name )[ 1 ]);
	const parts = name.trim().split(/\s+/),
		  nicks = parts.findIndex(p => p.startsWith("(")),
		  n = parts.length,
		  nick = nicks >= 0
	...
	if ( !nick && n === 2 ){
		...
		return atIndex >= 0
			? [parts[0].substring(0, atIndex), void 0, void 0]
			: /^[A-Z]/.test(parts[0])
			? [capitalize(parts[0]), void 0, void 0]
			: [void 0, parts[0], void 0];
		return [void 0, only, void 0];
	} else if ( nick && n <= 2 ) {
...
UserSchema.virtual( 'name' )
	.get( function getName() {
		...
		if ( this.preferredName ) {
			...
			return firstName + ' (' + this.preferredName + ')' + lastName;
		}
		return firstName + lastName;
	})
	.set( function setName( name ) {
		const [ firstName, nick, lastName ] = splitName( name );
		this.firstName = firstName;
		this.preferredName = nick;
