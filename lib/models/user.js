 ...
 *           completions:
 *             type: object
 *             description: string keys constructed from level-entityId-metric.name, values are sub-objects with keys metricName, lastUpdated, instance. The instance component in turn has the form {level, entity, score, time, provenance, tag}, provenance is either null (for component completions) or an array of instances of child completions, and tag is present only if not DEFAULT_TAG
