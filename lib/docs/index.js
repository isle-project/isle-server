...
const options = {
	...
	apis: [
		...
		path.resolve( __dirname, '..', 'cohorts.js' ),
		...
		path.resolve( __dirname, '..', 'namespaces.js' ),
		path.resolve( __dirname, '..', 'roles.js' ),
		path.resolve( __dirname, '..', 'settings.js' ),
		path.resolve( __dirname, '..', 'sketchpad.js' ),
		path.resolve( __dirname, '..', 'statistics.js' ),
		path.resolve( __dirname, '..', 'sticky_notes.js' ),
		path.resolve( __dirname, '..', 'text_editor_document.js' ),
		path.resolve( __dirname, '..', 'tickets.js' ),
		path.resolve( __dirname, '..', 'two_factor_authentication.js' )
	]
};
