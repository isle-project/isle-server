...
const errorLogStream = rfs.createStream( 'errors.log', {
	interval: '1m', // Monthly interval for error logging...
...
const format = ':remote-addr - :remote-user - :method :url :status :res[content-length] - :response-time ms - :date[web]';
...
app.use( ( err, req, res, next ) => {
	...
	errorLogStream.write( `${msg} - ${new Date().toLocaleTimeString()}` );
