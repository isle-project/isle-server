...
var storage = multer.diskStorage({
	...
	filename: function onFilename( req, file, cb ) {
		if ( file.fieldname === 'profile_picture' ) {
			console.log( req );
			return cb( path.join( 'profile_pictures', file.originalname ) );
		}
...
app.post( '/upload_profile_pic', fileUpload.single( 'profile_picture' ), passport.authenticate( 'jwt', { session: false }), function onUploadFile( req, res ) {
