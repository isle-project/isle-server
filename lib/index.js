...
app.post( '/upload_profile_pic', fileUpload.fields([{ name: 'avatar', maxCount: 1 }, { name: 'thumbnail', maxCount: 1 }], passport.authenticate( 'jwt', { session: false }), function onUploadFile( req, res ) {
	const avatar = req.files[ 'avatar' ][ 0 ];
	req.user.picture = avatar.filename;
