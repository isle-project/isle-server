...
const { BACKUP_DIRECTORY, FILES_DIRECTORY, LOCALES_DIRECTORY, LOGS_DIRECTORY, MEDIA_DIRECTORY, NAMESPACES_DIRECTORY } = require( './constants.js' );
...
app.use( '/files/', fromWithinApp, express.static( join( MEDIA_DIRECTORY, 'files' ) );
