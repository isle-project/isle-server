...
const accessLogStream = rfs.createStream( 'access.log', {
	interval: '10d', // Ten-day interval for access logging...
	maxSize: '50M',
	path: resolve( __dirname, './../logs' )
});
...
app.post( '/copy_lesson', passport.authenticate( 'jwt', { session: false }), function onCopyLesson( req, res ) {
...
app.post( '/update_lesson', passport.authenticate( 'jwt', { session: false }), function onUpdateLesson( req, res ) {
...
app.get( '/get_jitsi_token',
	passport.authenticate( 'jwt', { session: false }),
	async function getJitsiToken( req, res ) {
		if ( !jitsi.server ) {
