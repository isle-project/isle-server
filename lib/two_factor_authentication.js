 ...
 *               example: Two-factor authentication is already enabled for the user.
 */
 ...
 *             examples:
 *               expect-string-email:
 *                 value: Email has to be a string.
 *               expect-string-password:
 *                 value: Password has to be a string.
 *               expect-string-token:
 *                 value: Token has to be a string.
 *       401:
 ...
 *             examples:
 *               not-found:
 *                 value: User with the specified email address was not found.
 */
